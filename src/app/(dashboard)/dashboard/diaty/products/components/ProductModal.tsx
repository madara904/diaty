...
const ProductModal = ({ productName, onClose }: ProductModalProps) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      setLoading(true);
      const res = await fetch(`/api/search-food?productName=${productName}`);
  ...
  return (
    ...
    >
      <div className="max-w-4xl sm:max-w-7xl mx-auto px-4 py-8">
        <Button variant="ghost" onClick={onClose} className="mb-20">
                        ...
                        <CardContent>
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-sm">
                              <span>Carbs</span>
                              <span>
                                {calculateNutrition(productData.nutriments.carbohydrates)} g{" "}
                              </span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span>Fats</span>
                            ...
                            <div className="flex justify-between text-sm">
                              <span className="font-bold">Carbonhydrate units</span>
                              <span className="font-semibold text-red-500">{(Number(calculateNutrition(productData.nutriments.carbohydrates)) / 10).toFixed(1)} KE</span>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
                    ...
                    <TabsContent value="allergens" className="space-y-4">
                      <Card>
                        ...
                        <CardContent>
                          ...
                          <h3 className="mt-4">Dietary Information:</h3>
                          <ul className="list-disc pl-5">
